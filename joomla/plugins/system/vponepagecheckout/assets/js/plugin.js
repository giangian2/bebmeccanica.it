...
(function ($, win, doc, VPOPC, ProOPC, undefined) {
    ...
    ProOPC._init = function () {
        ...
        if (checkoutSubmitButton) {
            var observer = new MutationObserver(() => {
                if (checkoutSubmitButton.textContent) {
                    $('.proopc-order-confirmation-notice').text(checkoutSubmitButton.textContent)
                }

                if (checkoutSubmitButton.disabled && checkoutSubmitButton.textContent && checkoutSubmitButton.textContent !== checkoutSubmitButton.getAttribute('data-dvalue')) {
    ...
    ProOPC.initPaymentScripts = function () {
        ...
        if (typeof Virtuemart === 'object' && $('#paypal-button-container').length) {
            ...
            if (typeof vmPP === 'object' && selectedPayment.length && selectedPayment.data('pmtype') === 'paypal_checkout' && selectedPayment.data('pp') == 'buttons' && typeof vmPP.vmPPOrderId !== typeof undefined && !vmPP.vmPPOrderId) {
                $('.proopc-confirm-button-wrapper').addClass('disable-button');
