...
<?php endif; ?>
<div class="margin_collapsetop">class="margin_collapsetop"></div>
<header id="ttr_menu">
...
<a href="https://templatetoaster.com" target="_self" style="font-size:<?php echo $params->get('Designed_By_Link_FontSize'); ?>px;color:<?php echo $params->get('footer_designed_by_link_color');?>">
Joomla Template
</a>
