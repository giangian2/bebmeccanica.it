...
<head>
	...
	color:rgb(51,51,51) !important;
      ...
      .bottom-b .mod-articlescategory a{
	font-weight:bold;
        color:red;
      }
...
?>">
    ...
    <script>
       document.addEventListener("DOMContentLoaded",function(){
            if(window.location.href==="https://preprod.bebmeccanica.it/index.php" || window.location.href==="https://preprod.bebmeccanica.it/index.php/home" || window.location.href==="https://preprod.bebmeccanica.it/"  || window.location.href==="https://preprod.bebmeccanica.it"){
                document.querySelector(".container-component").style.display="none";
                let nuoviArrivi=document.querySelector(".bottom-b");
		nuoviArrivi.innerHTML+="<a style='font-weight:bold;' href='https://preprod.bebmeccanica.it/index.php'>Vai al negozio</a>";
		let nuoviArriviHeader=document.querySelector(".vmheader");
		nuoviArriviHeader.innerHTML+="&nbsp;&nbsp;&nbsp;&nbsp;<a style='font-size:16px;' href='https://preprod.bebmeccanica.it'>Vai al Negozio</a>";
            }
	    ...
	    let services_container=document.querySelector(".mod-articlescategory");
	    if(services_container!==null){
		    services_container.innerHTML="<li><h2>Scopri i nostri servizi</h2></li>"+services_container.innerHTML;
            }
