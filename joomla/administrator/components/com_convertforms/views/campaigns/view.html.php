...
class ConvertFormsViewCampaigns extends HtmlView
{
    ...
    protected function addToolBar() 
    {
        ...
        if ($canDo->get('core.create'))
        {
            ToolbarHelper::custom('campaigns.duplicate', 'copy', 'copy', 'JTOOLBAR_DUPLICATE', true);
        }
        ...
        {
            ToolbarHelper::deleteList('', 'campaigns.delete', 'JTOOLBAR_EMPTY_TRASH');
        }
        else if ($canDo->get('core.edit.state'))
        {
            ToolbarHelper::trash('campaigns.trash');
        }
