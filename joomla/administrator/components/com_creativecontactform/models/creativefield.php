...
class CreativeContactFormModelCreativeField extends JModelAdmin
{
	...
	function saveField()
	{
		...
		// 4.6.3
		$req->ordering_field = isset($_REQUEST['jform']['ordering_field']) ? (int)$_REQUEST['jform']['ordering_field'] : 0;
		...
		// 4.6.3
		if(in_array($req->id_type, array('13','14','15','19','21','22','23','24','25','26','27','28'))) {
			$response = array(0=>"license","1"=>0);
			return $response;
		}
