...
class CreativeContactFormModelCreativeFields extends JModelList {
	 ...
	 */
	// 4.6.3
	public function getCreativeMinFormId() {
		$db		= $this->getDbo();
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$formId = (int)$this->getUserStateFromRequest($this->context.'.filter.form_id', 'filter_form_id');
		// 4.6.3
		$formId = $formId == 0 ? $min_form_id : $formId;
	...
	protected function getListQuery()
	{
		...
		// 4.6.3
		$min_form_id = $this->getCreativeMinFormId();
