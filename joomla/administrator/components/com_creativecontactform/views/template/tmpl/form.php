...
<script type="text/javascript">
	var joomla4 = <?php if($joomla4) echo 'true'; else echo 'false'; ?>;
...
$(document).ready(function() {
	...
	$('.button-apply, .button-save, .button-save-new').click(function() {
		var form = document.adminForm;
...
(function($) {
	$(document).ready(function() {
		...
		$('.navigate_to_option').click(function() {
			...
			if(joomla4) {
				var elem_scroll_top_final = parseInt(elem_scroll_top - 75);
			}
			else {
