...
elseif($type == 'save_data') {
	$name = JFactory::getApplication()->input->getVar('name');
...
elseif($type=="update_star") {
	$sub_id = (int)$_POST["sub_id"];
	$star_index = (int)$_POST["star_index"];
	$query = "
				UPDATE
					`#__creative_submissions`
				SET
...
elseif($type=="update_imp") {
	$sub_id = (int)$_POST["sub_id"];
	$imp_index = (int)$_POST["imp_index"];
	$query = "
				UPDATE
					`#__creative_submissions`
				SET
...
elseif($type=="set_viewed") {
	$sub_id = (int)$_POST["sub_id"];
	$viewed_index = (int)$_POST["viewed_index"];
	echo $query = "
				UPDATE
					`#__creative_submissions`
				SET
